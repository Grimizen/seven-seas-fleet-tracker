...
export function newShip(id='sea-wren',name='Sea Wren'){return {id,name,type:'Large Sloop',minCrew:5,maxCrew:48,maxGuns:9,archived:false,hull:20,maxHull:20,crew:16,crewLevel:1,sails:1,sinking:null,stations:Object.fromEntries(Object.entries(stationDefaults).map(([k,max])=>[k,{hp:max,max,assigned:0}])),guns:Array.from({length:4},(_,i)=>({id:`gun-${i+1}`,name:`${i<2?'Port':'Starboard'} ${i%2+1}`,side:i<2?'Port':'Starboard',condition:'operational',loaded:'Lead shot',assigned:0})),inventory:[{id:'lead',name:'Lead shot',category:'Ammunition',quantity:26}],officers:{Captain:'',Gunner:'','First Mate':'',Helmsman:'',Bosun:'',Surgeon:'',Chaplain:'',Carpenter:'',Navigator:'',Lookout:'',Quartermaster:'',Cook:''}};}
