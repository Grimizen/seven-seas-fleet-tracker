...
export function reclassify(doc,template){
  ...
  next.config={...old,type:template.type,maxHull:template.maxHull,minCrew:template.minCrew,maxCrew:template.maxCrew,maxGuns:template.maxGuns,stationMax:structuredClone(template.stationMax)};
