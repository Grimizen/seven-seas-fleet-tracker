...
export function fleetControls(s,archived,custom,escape){
  ...
  <div class="card stack"><label>New vessel name<input id="new-name" maxlength="60" placeholder="Vessel name"></label><button id="new-ship" class="primary">Add a Large Sloop</button><p class="subtle">Change its class below after adding it.</p></div>
  ...
  <button id="load-templates">Load saved group templates</button>
